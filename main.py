...
key = 'auto_oem/etl/vehicle_sales_deduped.parquet'

df_to_s3(vehicle_sales_deduped, key, s3_bucket, aws_access_key_id, aws_secret_access_key, file_format='parquet')
