...
vehicle_sales_validated = validate_vehicle_sales_schema(vehicle_sales_deduped)
...
df_to_s3(vehicle_sales_validated, key, s3_bucket, aws_access_key_id, aws_secret_access_key)
