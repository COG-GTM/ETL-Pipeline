...
from src.load_data_to_s3 import df_to_s3_parquet
...
# Step 3: Upload to S3 as Parquet (partitioned by region)
print("\nUploading cleaned data to S3 as Parquet...")
s3_bucket = 'cognition-devin'
base_key = 'auto_oem/etl/vehicle_sales_deduped'

df_to_s3_parquet(vehicle_sales_deduped, base_key, s3_bucket, aws_access_key_id, aws_secret_access_key)
